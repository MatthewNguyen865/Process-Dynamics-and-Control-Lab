...
class EulerSimulator:
    def simulate(self, model, initial_temp, time_step=time_step, num_steps=num_steps, controller=None, disturbance=None):
        ...
        for step in range(num_steps):
            ...
            current_temp += derivative * time_step
            if disturbance is not None:
                current_temp += disturbance(step * time_step)
